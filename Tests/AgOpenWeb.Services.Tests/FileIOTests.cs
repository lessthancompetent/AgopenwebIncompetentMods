...
public class FileIOTests
{
    ...
    // ~/Documents/AgOpenWeb/appsettings.json isn't clobbered during test
    ...
    {
        var dir = Path.Combine(Path.GetTempPath(), "AgOpenWeb_SettingsTests_" + Guid.NewGuid().ToString("N"));
