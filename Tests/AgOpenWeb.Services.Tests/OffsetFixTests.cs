...
public class OffsetFixTests
{
    ...
    public void AutoSteerService_DriftAppliedToLocalCoordinates()
    {
        ...
        var autoSteer = new AgOpenWeb.Services.AutoSteer.AutoSteerService(
    ...
    public void ToolPositionService_FollowsVehicle()
    {
        ...
        var toolService = new AgOpenWeb.Services.Tool.ToolPositionService(AgOpenWeb.Models.Configuration.ConfigurationStore.Instance);

        // Configure a rear-fixed hitch at 2m behind
        var config = AgOpenWeb.Models.Configuration.ConfigurationStore.Instance;
        config.Tool.HitchLength = 2.0;
        config.Tool.IsToolRearFixed = true;

        // Vehicle at (100, 200) heading north (0 radians)
        var vehiclePos = new AgOpenWeb.Models.Base.Vec3(100, 200, 0);
        ...
        var driftedPos = new AgOpenWeb.Models.Base.Vec3(100, 190, 0); // 10m south
    ...
    public void ToolPositionService_ResetAfterLargeJump_SnapsImmediately()
    {
        ...
        for (int i = 0; i < 60; i++)
        {
            var pos = new AgOpenWeb.Models.Base.Vec3(100, 200 + i * 0.5, 0);
        ...
        var jumpedPos = new AgOpenWeb.Models.Base.Vec3(100, 330, 0);
    ...
    public void ToolPositionService_ResetPlacesHitchBehindVehicle()
    {
        ...
        var pos = new AgOpenWeb.Models.Base.Vec3(100, 200, 0);
    ...
    public void ToolPositionService_ResetThenUpdateProducesConsistentPositions()
    {
        ...
        for (int i = 0; i < 60; i++)
            toolService.Update(new AgOpenWeb.Models.Base.Vec3(0, i * 0.5, 0), 0);

        // Apply offset by resetting to a shifted position (simulate 10m north drift)
        var newPos = new AgOpenWeb.Models.Base.Vec3(0, 40, 0);
    ...
    public void ToolPositionService_TrailingStillWorksAtNormalSpeed()
    {
        ...
        for (int i = 0; i < 60; i++)
        {
            var pos = new AgOpenWeb.Models.Base.Vec3(0, i * 1.0, 0);
            toolService.Update(pos, 0);
        }
        ...
        for (int i = 0; i < 20; i++)
        {
            var pos = new AgOpenWeb.Models.Base.Vec3(i * 1.0, 60, Math.PI / 2); // Heading east
