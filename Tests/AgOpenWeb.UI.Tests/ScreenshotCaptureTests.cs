...
public class ScreenshotCaptureTests
{
    ...
    public void Capture_GridVisible_Toggle()
    {
        CaptureToggle(
            ...
            _ => AgOpenWeb.Models.Configuration.ConfigurationStore.Instance.Display.GridVisible = true,
            _ => AgOpenWeb.Models.Configuration.ConfigurationStore.Instance.Display.GridVisible = false);
    }
