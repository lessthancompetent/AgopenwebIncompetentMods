...
public class OffsetFixScreenshotTests
{
    ...
    public void OffsetFix_TrailingImplementFollowsVehicle()
    {
        ...
        var toolService = new AgOpenWeb.Services.Tool.ToolPositionService(
        ...
        AgOpenWeb.Models.Configuration.ConfigurationStore.Instance.Display.GridVisible = true;
        ...
        var outerPoly = new AgOpenWeb.Models.BoundaryPolygon();
        outerPoly.Points.Add(new AgOpenWeb.Models.BoundaryPoint { Easting = -20, Northing = -20 });
        outerPoly.Points.Add(new AgOpenWeb.Models.BoundaryPoint { Easting = 20, Northing = -20 });
        outerPoly.Points.Add(new AgOpenWeb.Models.BoundaryPoint { Easting = 20, Northing = 20 });
        outerPoly.Points.Add(new AgOpenWeb.Models.BoundaryPoint { Easting = -20, Northing = 20 });
        var boundary = new AgOpenWeb.Models.Boundary { OuterBoundary = outerPoly };
