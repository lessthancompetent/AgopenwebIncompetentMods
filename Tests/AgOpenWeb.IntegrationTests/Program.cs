...
//   dotnet run --project Tests/AgOpenWeb.IntegrationTests/
//
// Headless mode (CI compatible):
//   dotnet run --project Tests/AgOpenWeb.IntegrationTests/ -- --headless
...
using AgOpenWeb.Desktop;
using AgOpenWeb.Desktop.Views;
using AgOpenWeb.IntegrationTests;
...
sealed class Program
{
    ...
    // UTurn test moved to NUnit: AgOpenWeb.Services.Tests/AutoSteerUTurnNUnitTests.cs
    ...
    public static int Main(string[] args)
    {
        ...
        _tempDir = Path.Combine(Path.GetTempPath(), $"AgOpenWeb_IntTest_{Guid.NewGuid():N}");
    ...
    static async Task SetupTestField(MainViewModel vm)
    {
                ...
                if (vm.IsFieldOpen)
                {
                    ...
                    if (vm.SavedTracks.Count == 0)
                    {
                        ...
                        if (bnd != null && bnd.Count > 0)
                        {
                            ...
                            var userTrack = new AgOpenWeb.Models.Track.Track
                            {
                                Name = "AB_Test",
                                Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
        ...
        var origin = new AgOpenWeb.Models.Wgs84(42.0308, -93.6319);
        AgOpenWeb.Models.State.ApplicationState.Instance.Field.LocalPlane =
            new AgOpenWeb.Models.LocalPlane(origin, new AgOpenWeb.Models.SharedFieldProperties());
        AgOpenWeb.Models.State.ApplicationState.Instance.Field.OriginLatitude = 42.0308;
        AgOpenWeb.Models.State.ApplicationState.Instance.Field.OriginLongitude = -93.6319;
        ...
        var headlandSeg = new AgOpenWeb.Models.Headland.HeadlandSegment
        {
            Name = "Boundary",
            Type = AgOpenWeb.Models.Headland.HeadlandSegmentType.Boundary,
            Offset = 20,
            BoundaryPoints = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
        ...
        var diagTrack = new AgOpenWeb.Models.Track.Track
        {
            Name = "AB_Diagonal",
            Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
    ...
    static async Task RunTileTest(IClassicDesktopStyleApplicationLifetime lifetime)
    {
        ...
        try
        {
            ...
            simService.Initialize(new AgOpenWeb.Models.Wgs84(0.002, 0.0));

            // Set 2D north-up mode
            vm.Is2DMode = true;
            vm.CameraPitch = -90.0;
            vm.CameraMode = AgOpenWeb.Models.CameraMode.NorthUp;
...
");
    ...
    static async Task RunScenario(IClassicDesktopStyleApplicationLifetime lifetime)
    {
        ...
        await Delay(200);
        if (vm.CameraMode != AgOpenWeb.Models.CameraMode.NorthUp)
        ...
        await Delay(200);
        if (vm.CameraMode != AgOpenWeb.Models.CameraMode.HeadingUp)
        ...
        vm.OnUserPan();
        await Delay(200);
        if (vm.CameraMode != AgOpenWeb.Models.CameraMode.Free)
    ...
    static async Task RunDebugDumpTest(Window window, MainViewModel vm)
    {
        ...
        // Find the dump zip
        var dumpDir = Path.Combine(Path.GetTempPath(), "AgOpenWeb", "dumps");
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        vm.CameraMode = AgOpenWeb.Models.CameraMode.HeadingUp;
        for (int i = 0; i < 30; i++)
        {
        ...
        vm.CameraMode = AgOpenWeb.Models.CameraMode.Free;
        await Delay(300);
        Dispatcher.UIThread.RunJobs();
        Console.Write($"[mode={vm.CameraMode}] ");
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        vm.PlaceFlagAtWorldPosition(20.0, 30.0, AgOpenWeb.Models.FlagColor.Green);
        await Delay(300);
    ...
    static async Task RunTrackManagementScenario(Window window, MainViewModel vm)
    {
        ...
        vm.State.UI.CloseDialog();
        ConfigurationStore.Instance.Tram.DisplayMode = AgOpenWeb.Models.Configuration.TramDisplayMode.All;
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        vm.CameraMode = AgOpenWeb.Models.CameraMode.Free; // Fixed camera, no follow
        vm.Is2DMode = true;
        vm.CameraPitch = -90.0;
        vm.IsSimulatorPanelVisible = false;
        vm.State.UI.IsSimulatorPanelVisible = false;
        // Force day mode and disable auto day/night
        AgOpenWeb.Models.Configuration.ConfigurationStore.Instance.Display.AutoDayNight = false;
        if (!vm.IsDayMode)
            vm.ToggleDayNightCommand?.Execute(null);
        var mapService = App.Services!.GetRequiredService<IMapService>();
        ...
        var weTrack = new AgOpenWeb.Models.Track.Track
        {
            Name = "W-E Test",
            Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
...
");
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        double originLat = AgOpenWeb.Models.State.PersistentAppState.Instance.SimulatorLatitude;
        double originLon = AgOpenWeb.Models.State.PersistentAppState.Instance.SimulatorLongitude;
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        var testTrack = new AgOpenWeb.Models.Track.Track
        {
            Name = "E2E Test Track",
            Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
        ...
        // Add a hidden track
        var hiddenTrack = new AgOpenWeb.Models.Track.Track
        {
            Name = "Hidden Track",
            Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
            ...
            Type = AgOpenWeb.Models.Track.TrackType.Curve,
            IsVisible = false,
            NudgeDistance = -3.25
        };
        ...
        Window window, MainViewModel vm, IGpsSimulationService simService)
    {
        ...
        var extraTrack = new AgOpenWeb.Models.Track.Track
        {
            Name = "Diagonal Test",
            Points = new System.Collections.Generic.List<AgOpenWeb.Models.Base.Vec3>
            {
        ...
        config.Tram.DisplayMode = AgOpenWeb.Models.Configuration.TramDisplayMode.All;
        ...
        config.Tram.DisplayMode = AgOpenWeb.Models.Configuration.TramDisplayMode.LinesOnly;
        await Delay(100);
        CaptureScreenshot(window, "tram_02_lines_only");

        config.Tram.DisplayMode = AgOpenWeb.Models.Configuration.TramDisplayMode.OuterOnly;
        await Delay(100);
        CaptureScreenshot(window, "tram_03_outer_only");

        config.Tram.DisplayMode = AgOpenWeb.Models.Configuration.TramDisplayMode.Off;
        await Delay(100);
    ...
    {
        var simState = AgOpenWeb.Models.State.PersistentAppState.Instance;
