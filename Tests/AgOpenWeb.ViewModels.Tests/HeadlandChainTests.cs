...
public class HeadlandChainTests
{
    ...
    public void ExtensionsSavedAndLoaded()
    {
        ...
        try
        {
            ...
            AgOpenWeb.Services.Headland.HeadlandSegmentFileService.Save(tempDir, segments);
            var loaded = AgOpenWeb.Services.Headland.HeadlandSegmentFileService.Load(tempDir);
