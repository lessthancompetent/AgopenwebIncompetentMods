...
public class TramLineTests
{
    ...
    public void UShapedField_HorizontalTramLines_SplitAtBoundaryCrossings()
    {
        ...
        var system = new AgOpenWeb.Models.Tram.TramSystem
        {
            Name = "Test",
            TramWidth = 24.0,
    ...
    public void TramSystemFileService_SaveAndLoad_PreservesAllProperties()
    {
        ...
        try
        {
            var systems = new List<AgOpenWeb.Models.Tram.TramSystem>
            {
                new()
                {
                    Name = "Sprayer Tracks",
                    ...
                    Mode = AgOpenWeb.Models.Tram.TramSystemMode.TrackLine,
                    Offset = 2.5,
                    Direction = AgOpenWeb.Models.Tram.TramDirection.Left,
                    PassCount = 5,
                    IsEnabled = true
                },
                new()
                {
                    ...
                    ReferenceBoundaryIndex = -1,
                    TramWidth = 18.0,
                    Mode = AgOpenWeb.Models.Tram.TramSystemMode.Edge,
                    Offset = -1.0,
                    Direction = AgOpenWeb.Models.Tram.TramDirection.Right,
                    PassCount = 3,
                    IsEnabled = false
                }
            };
            ...
            Assert.That(loaded[0].Mode, Is.EqualTo(AgOpenWeb.Models.Tram.TramSystemMode.TrackLine));
            Assert.That(loaded[0].Offset, Is.EqualTo(2.5).Within(0.001));
            Assert.That(loaded[0].Direction, Is.EqualTo(AgOpenWeb.Models.Tram.TramDirection.Left));
            ...
            Assert.That(loaded[1].Mode, Is.EqualTo(AgOpenWeb.Models.Tram.TramSystemMode.Edge));
            Assert.That(loaded[1].Direction, Is.EqualTo(AgOpenWeb.Models.Tram.TramDirection.Right));
    ...
    public void TramSystemFileService_SaveEmptyList_LoadReturnsEmpty()
    {
        ...
        try
        {
            TramSystemFileService.Save(tempDir, new List<AgOpenWeb.Models.Tram.TramSystem>());
            var loaded = TramSystemFileService.Load(tempDir);
    ...
    public void GenerateForSystem_PassCount2_GeneratesMoreLinesThanPassCount1()
    {
        ...
        var system1 = new AgOpenWeb.Models.Tram.TramSystem
        {
            Name = "1 Pass",
            TramWidth = 24.0,
            Mode = AgOpenWeb.Models.Tram.TramSystemMode.TrackLine,
        ...
        var system2 = new AgOpenWeb.Models.Tram.TramSystem
        {
            Name = "2 Pass",
            TramWidth = 24.0,
            Mode = AgOpenWeb.Models.Tram.TramSystemMode.TrackLine,
    ...
    public void TramConfig_Systems_IsObservableCollection()
    {
        ...
        config.Systems.Add(new AgOpenWeb.Models.Tram.TramSystem { Name = "Test" });
    ...
    public void TramSystem_DefaultValues_AreCorrect()
    {
        ...
        Assert.That(system.Mode, Is.EqualTo(AgOpenWeb.Models.Tram.TramSystemMode.TrackLine));
        Assert.That(system.Offset, Is.EqualTo(0.0));
        Assert.That(system.Direction, Is.EqualTo(AgOpenWeb.Models.Tram.TramDirection.Symmetric));
