...
public class MapService : IMapService
{
    ...
    public void SetNextTrack(AgOpenWeb.Models.Track.Track? track) => _mapControl?.SetNextTrack(track);
    public void SetIsInYouTurn(bool isInTurn) => _mapControl?.SetIsInYouTurn(isInTurn);
    public void SetActiveTrack(AgOpenWeb.Models.Track.Track? track) => _mapControl?.SetActiveTrack(track);
    public void SetBaseTrack(AgOpenWeb.Models.Track.Track? track) => _mapControl?.SetBaseTrack(track);

    public void SetRecordedPaths(IReadOnlyList<AgOpenWeb.Models.Track.Track> paths) =>
        _mapControl?.SetRecordedPaths(paths);

    public void SetContourStrips(IReadOnlyList<AgOpenWeb.Models.Track.Track> strips) =>
