...
public class MapService : IMapService
{
    ...
    public void SetRecordedPaths(System.Collections.Generic.IReadOnlyList<AgOpenWeb.Models.Track.Track> paths) =>
        GetMapControl().SetRecordedPaths(paths);

    public void SetContourStrips(System.Collections.Generic.IReadOnlyList<AgOpenWeb.Models.Track.Track> strips) =>
