...
public partial class MainViewModel
{
    ...
    private AgOpenWeb.Models.LocalPlane? _simulatorLocalPlane;
    ...
    private void OnSimulatorGpsDataUpdated(object? sender, GpsSimulationEventArgs e)
    {
        ...
        {
            var sharedProps = new AgOpenWeb.Models.SharedFieldProperties();
            AgOpenWeb.Models.Wgs84 origin;
            ...
            if (State.Field.OriginLatitude != 0 && State.Field.OriginLongitude != 0)
            {
                ...
                origin = new AgOpenWeb.Models.Wgs84(State.Field.OriginLatitude, State.Field.OriginLongitude);
            ...
            _simulatorLocalPlane = new AgOpenWeb.Models.LocalPlane(origin, sharedProps);
        }
        ...
        var position = new AgOpenWeb.Models.Position
        {
        ...
        var gpsData = new AgOpenWeb.Models.GpsData
        {
    ...
    public void SetSimulatorCoordinates(double latitude, double longitude)
    {
        ...
        _simulatorService.Initialize(new AgOpenWeb.Models.Wgs84(latitude, longitude));
        _simulatorService.StepDistance = 0;
    ...
    /// </summary>
    public AgOpenWeb.Models.Wgs84 GetSimulatorPosition()
    {
