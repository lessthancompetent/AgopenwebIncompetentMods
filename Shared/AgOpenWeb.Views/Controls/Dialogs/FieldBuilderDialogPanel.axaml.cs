...
public partial class FieldBuilderDialogPanel : UserControl
{
    ...
    private void AddTramSystem_Click(object? sender, RoutedEventArgs e)
    {
        ...
        var sys = new AgOpenWeb.Models.Tram.TramSystem
        {
            Name = $"Tram {vm.TramSystems.Count + 1} ({refName})",
            TramWidth = 24.0,
            PassCount = 1,
            Direction = AgOpenWeb.Models.Tram.TramDirection.Symmetric,
            Mode = AgOpenWeb.Models.Tram.TramSystemMode.TrackLine,
    ...
    private AgOpenWeb.Models.Tram.TramSystem? _editingTramSystem;
    private bool _isCreatingNewSystem;
    private bool _isPopulatingTramEdit;
    private (string? RefTrack, int RefBndIdx, double Width, AgOpenWeb.Models.Tram.TramSystemMode Mode,
             double Offset, AgOpenWeb.Models.Tram.TramDirection Dir, int Passes, bool Enabled) _editSnapshot;
    ...
    private void EditTramSystem_Click(object? sender, RoutedEventArgs e)
    {
        ...
        if (list?.SelectedItem is AgOpenWeb.Models.Tram.TramSystem sys)
            OpenTramSystemEditPanel(sys);
    }

    private void OpenTramSystemEditPanel(AgOpenWeb.Models.Tram.TramSystem sys)
    {
    ...
    private void PopulateTramEditPanel(AgOpenWeb.Models.Tram.TramSystem sys)
    {
        ...
        if (combo != null && DataContext is MainViewModel vm)
        {
            ...
            {
                if (t.Type == AgOpenWeb.Models.Track.TrackType.RecordedPath ||
                    t.Type == AgOpenWeb.Models.Track.TrackType.Contour)
                    continue;
                items.Add(t.Name);
            }
    ...
    {
        if (_editingTramSystem == null) return;
        _editingTramSystem.Mode = AgOpenWeb.Models.Tram.TramSystemMode.TrackLine;
        UpdateTramEditHighlights();
        if (DataContext is MainViewModel vm) RebuildTramLines(vm);
    }
    ...
    {
        if (_editingTramSystem == null) return;
        _editingTramSystem.Mode = AgOpenWeb.Models.Tram.TramSystemMode.Edge;
        UpdateTramEditHighlights();
        if (DataContext is MainViewModel vm) RebuildTramLines(vm);
    }
    ...
    {
        if (_editingTramSystem == null) return;
        _editingTramSystem.Direction = AgOpenWeb.Models.Tram.TramDirection.Left;
        UpdateTramEditHighlights();
        if (DataContext is MainViewModel vm) RebuildTramLines(vm);
    }
    ...
    {
        if (_editingTramSystem == null) return;
        _editingTramSystem.Direction = AgOpenWeb.Models.Tram.TramDirection.Symmetric;
        UpdateTramEditHighlights();
        if (DataContext is MainViewModel vm) RebuildTramLines(vm);
    }
    ...
    {
        if (_editingTramSystem == null) return;
        _editingTramSystem.Direction = AgOpenWeb.Models.Tram.TramDirection.Right;
        UpdateTramEditHighlights();
        if (DataContext is MainViewModel vm) RebuildTramLines(vm);
    }
    ...
    private void UpdateTramEditHighlights()
    {
        ...
        if (btnTrackLine != null)
            btnTrackLine.Background = _editingTramSystem.Mode == AgOpenWeb.Models.Tram.TramSystemMode.TrackLine
                ? accentBrush : normalBrush;
        if (btnEdge != null)
            btnEdge.Background = _editingTramSystem.Mode == AgOpenWeb.Models.Tram.TramSystemMode.Edge
                ? accentBrush : normalBrush;
        ...
        if (btnLeft != null)
            btnLeft.Background = _editingTramSystem.Direction == AgOpenWeb.Models.Tram.TramDirection.Left
                ? accentBrush : normalBrush;
        if (btnSymm != null)
            btnSymm.Background = _editingTramSystem.Direction == AgOpenWeb.Models.Tram.TramDirection.Symmetric
                ? accentBrush : normalBrush;
        if (btnRight != null)
            btnRight.Background = _editingTramSystem.Direction == AgOpenWeb.Models.Tram.TramDirection.Right
                ? accentBrush : normalBrush;
    }
    ...
    private void RebuildTramLines(MainViewModel vm)
    {
        ...
        if (vm.ActiveField != null)
        {
            try
            {
                ...
                {
                    AgOpenWeb.Services.Tram.TramSystemFileService.Save(
