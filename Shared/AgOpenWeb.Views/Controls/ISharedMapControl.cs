...
public interface ISharedMapControl
{
    ...
    void SetHeadlandLine(IReadOnlyList<AgOpenWeb.Models.Base.Vec3>? headlandPoints);
    void SetHeadlandPreview(IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? previewPoints);
    ...
    void SetPendingPointA(AgOpenWeb.Models.Position? pointA);
