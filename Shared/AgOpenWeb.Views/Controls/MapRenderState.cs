...
internal class MapRenderState
{
    ...
    // Headland
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec3>? HeadlandLine;
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? HeadlandPreview;
    ...
    // Tracks
    public AgOpenWeb.Models.Track.Track? ActiveTrack;
    public AgOpenWeb.Models.Track.Track? BaseTrack;
    public AgOpenWeb.Models.Track.Track? NextTrack;
    public AgOpenWeb.Models.Position? PendingPointA;
    public IReadOnlyList<AgOpenWeb.Models.Track.Track> RecordedPaths = Array.Empty<AgOpenWeb.Models.Track.Track>();
    public IReadOnlyList<AgOpenWeb.Models.Track.Track> ContourStrips = Array.Empty<AgOpenWeb.Models.Track.Track>();
    ...
    // Selection markers
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? SelectionMarkers;
    public (AgOpenWeb.Models.Base.Vec2 Start, AgOpenWeb.Models.Base.Vec2 End)? ClipLine;
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? ClipPath;
    ...
    // Tram lines
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? TramOuterTrack;
    public IReadOnlyList<AgOpenWeb.Models.Base.Vec2>? TramInnerTrack;
    public IReadOnlyList<IReadOnlyList<AgOpenWeb.Models.Base.Vec2>>? TramParallelLines;
    public IReadOnlyList<IReadOnlyList<AgOpenWeb.Models.Base.Vec2>>? TramBoundaryExtraLines;
    public AgOpenWeb.Models.Configuration.TramDisplayMode TramDisplayMode;
