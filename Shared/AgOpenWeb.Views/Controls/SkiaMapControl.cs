...
using Vec2 = AgOpenWeb.Models.Base.Vec2;
using Vec3 = AgOpenWeb.Models.Base.Vec3;
...
public partial class SkiaMapControl : Control, ISharedMapControl
{
    ...
    private const int MaxSections = AgOpenWeb.Models.Configuration.ToolConfig.MaxSections;
    ...
    private AgOpenWeb.Models.Position? _pendingPointA;
    ...
    public SkiaMapControl()
    {
        ...
        try
        {
            var dayUri = new Uri("avares://AgOpenWeb.Views/Assets/Images/GroundTexture.png");
            using var dayStream = AssetLoader.Open(dayUri);
            _groundTextureDay = new Bitmap(dayStream);
            var nightUri = new Uri("avares://AgOpenWeb.Views/Assets/Images/GroundTextureDark.png");
        ...
        try
        {
            var uri = new Uri("avares://AgOpenWeb.Views/Assets/Images/TractorAoG.png");
        ...
        try
        {
            var uri = new Uri("avares://AgOpenWeb.Views/Assets/Images/FrontWheels.png");
            using var stream = AssetLoader.Open(uri);
    ...
    public void SetPendingPointA(AgOpenWeb.Models.Position? pointA)
    {
