    ...
    ISettingsService settingsService) : IConfigurationService
{
    ...
    private void ApplyAppSettingsToStore(AppSettings settings)
    {
        ...
        store.Display.LeftNavPanelX = settings.LeftNavPanelX;
        store.Display.LeftNavPanelY = settings.LeftNavPanelY;
        store.Display.RightNavPanelX = settings.RightNavPanelX;
        store.Display.RightNavPanelY = settings.RightNavPanelY;
        store.Display.BottomNavPanelX = settings.BottomNavPanelX;
        store.Display.BottomNavPanelY = settings.BottomNavPanelY;
        store.Display.SectionPanelX = settings.SectionPanelX;
        store.Display.SectionPanelY = settings.SectionPanelY;
    ...
    private void ApplyStoreToAppSettings(AppSettings settings)
    {
        ...
        settings.LeftNavPanelX = store.Display.LeftNavPanelX;
        settings.LeftNavPanelY = store.Display.LeftNavPanelY;
        settings.RightNavPanelX = store.Display.RightNavPanelX;
        settings.RightNavPanelY = store.Display.RightNavPanelY;
        settings.BottomNavPanelX = store.Display.BottomNavPanelX;
        settings.BottomNavPanelY = store.Display.BottomNavPanelY;
        settings.SectionPanelX = store.Display.SectionPanelX;
        settings.SectionPanelY = store.Display.SectionPanelY;
