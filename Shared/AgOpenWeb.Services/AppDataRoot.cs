...
/// <summary>
/// Single source of truth for the <c>AgOpenWeb</c> data root (fields, vehicle/tool
...
/// used to yield a RELATIVE "AgOpenWeb" path under the CWD → data inside /opt → lost.
/// </summary>
public static class AppDataRoot
{
    public const string EnvVar = "AGOPENWEB_DATA";

    /// <summary>The <c>AgOpenWeb</c> data root. Callers append their subfolder
