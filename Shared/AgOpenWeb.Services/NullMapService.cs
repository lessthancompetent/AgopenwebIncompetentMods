...
/// browser needs is read from <see cref="AgOpenWeb.Models.State.ApplicationState"/>
...
public sealed class NullMapService : IMapService
{
    ...
    public void SetNextTrack(AgOpenWeb.Models.Track.Track? track) { }
    public void SetIsInYouTurn(bool isInTurn) { }

    public void SetActiveTrack(AgOpenWeb.Models.Track.Track? track) { }
    public void SetBaseTrack(AgOpenWeb.Models.Track.Track? track) { }
