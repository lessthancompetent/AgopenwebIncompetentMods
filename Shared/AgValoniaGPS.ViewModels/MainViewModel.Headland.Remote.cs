...
public partial class MainViewModel
{
    ...
    private static double BoundaryBboxDiagonal(
        System.Collections.Generic.IReadOnlyList<AgValoniaGPS.Models.BoundaryPoint> pts)
    {
    ...
    private static int FindNearestBoundaryVertex(
        System.Collections.Generic.IReadOnlyList<AgValoniaGPS.Models.BoundaryPoint> pts, double e, double n)
    {
    ...
    private static List<Vec3> ExtractBoundaryRing(
        System.Collections.Generic.IReadOnlyList<AgValoniaGPS.Models.BoundaryPoint> pts, int idx1, int idx2)
    {
        int count = pts.Count;
